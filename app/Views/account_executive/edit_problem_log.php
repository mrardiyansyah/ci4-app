        ...
        <div class="col-lg">
            ...
            <div class="card col-lg shadow">
                <div class="card-body col-lg-9">
                    <form action="<?= base_url('account-executive/edit-problem-log/' . $cancellation_log['id_user_cancellation']); ?>" method="post" id="form-problem-report-user" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            <label for="customer" class="col-sm-3 col-form-label-sm">Customer</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm" id="customer" name="customer" value="<?= $cancellation_log['name_customer']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group date" id="datetimepicker-datereport" data-target-input="nearest">
                                    <input type="text" class="form-control form-control-sm datepicker datetimepicker-input <?php if (isset($validation)) echo $validation->hasError('date_report') ? 'is-invalid' : ''; ?>" data-toggle="datetimepicker" data-target="#datetimepicker-datereport" name="date_report" id="date_report" value="<?= set_value('date_report'); ?><?= $cancellation_log['date_report']; ?>" placeholder="DD-MM-YYYY" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control form-control-sm <?php if (isset($validation)) echo $validation->hasError('description') ? 'is-invalid' : ''; ?>" name="description" id="description" cols="30" rows="4" value="<?= set_value('description'); ?>" placeholder="Type something here..."><?= set_value('description'); ?><?= $cancellation_log['description']; ?></textarea>
                                <?php if (isset($validation)) : ?>
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control form-control-sm <?php if (isset($validation)) echo $validation->hasError('solution') ? 'is-invalid' : ''; ?>" name="solution" id="solution" cols="30" rows="4" value="<?= set_value('solution'); ?>" placeholder="Type something here..."><?= set_value('solution'); ?><?= ($cancellation_log['suggestion_solution']) ?? ''; ?></textarea>
                                <?php if (isset($validation)) : ?>
                                    <div class="invalid-feedback">
