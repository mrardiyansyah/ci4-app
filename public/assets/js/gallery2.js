let modalIdReport = $('#image-gallery-report');
var currentImg;
...
$(document)
    .keydown(function (e) {
        switch (e.which) {
            case 37: // left
                if ((modalIdReport.data('bs.modal') || {})._isShown && $('#show-previous-image').is(":visible")) {
                    $('#show-previous-image')
                        .click();
                }
                break;
            ...
            case 39: // right
                if ((modalIdReport.data('bs.modal') || {})._isShown && $('#show-next-image').is(":visible")) {
                    $('#show-next-image')
                        .click();
                }
                break;
